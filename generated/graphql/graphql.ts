...
export type BigEventsForHomeQuery = { __typename?: 'Query', events?: { __typename?: 'EventsCollectionSegment', totalCount: number, items?: Array<{ __typename?: 'EventDto', id: string, title: string, description: string, image: string, startTime: any, endTime: any, addressLine: string, city: string, postalCode: string }> | null } | null };
...
export type SliderEventsForHomeQuery = { __typename?: 'Query', events?: { __typename?: 'EventsCollectionSegment', items?: Array<{ __typename?: 'EventDto', id: string, title: string, description: string, mediumImage: string, startTime: any, endTime: any, addressLine: string, city: string, postalCode: string }> | null } | null };
...
export type CalendarEventsQuery = { __typename?: 'Query', events?: { __typename?: 'EventsCollectionSegment', items?: Array<{ __typename?: 'EventDto', id: string, title: string, description: string, startTime: any, endTime: any, addressLine: string, city: string, postalCode: string, image: string }> | null } | null };
...
export type CalendarEventsBigImageQuery = { __typename?: 'Query', events?: { __typename?: 'EventsCollectionSegment', items?: Array<{ __typename?: 'EventDto', id: string, title: string, description: string, startTime: any, endTime: any, image: string, addressLine: string, city: string, postalCode: string }> | null } | null };
...
export type GetMediumEventImageQueryVariables = Exact<{
  EventId: Scalars['ID']['input'];
}>;


export type GetMediumEventImageQuery = { __typename?: 'Query', event?: { __typename?: 'EventDto', mediumImage: string } | null };

export type GetBigEventImageQueryVariables = Exact<{
  EventId: Scalars['ID']['input'];
}>;


export type GetBigEventImageQuery = { __typename?: 'Query', event?: { __typename?: 'EventDto', image: string } | null };

export type AskChatGptQueryVariables = Exact<{
  prompt: Scalars['String']['input'];
}>;


export type AskChatGptQuery = { __typename?: 'Query', chatGPTDescription: { __typename?: 'ChatGPTPayload', isSuccessful: boolean, response: string, message: string } };

export type AddSelfMutationVariables = Exact<{
  addSelfInput: AddSelfToEventInput;
}>;


export type AddSelfMutation = { __typename?: 'Mutation', addSelfToEvent: { __typename?: 'AddUserToEventPayload', isSuccessful: boolean, message: string } };
...
export type IsAdminOrUnionQueryVariables = Exact<{ [key: string]: never; }>;


export type IsAdminOrUnionQuery = { __typename?: 'Query', isAdminOrUnion: boolean };
...
export const GetMediumEventImageDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetMediumEventImage"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"EventId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"event"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"id"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"EventId"}}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"mediumImage"}}]}}]}}]} as unknown as DocumentNode<GetMediumEventImageQuery, GetMediumEventImageQueryVariables>;
export const GetBigEventImageDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetBigEventImage"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"EventId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"event"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"id"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"EventId"}}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"image"}}]}}]}}]} as unknown as DocumentNode<GetBigEventImageQuery, GetBigEventImageQueryVariables>;
export const AskChatGptDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"AskChatGPT"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"prompt"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"chatGPTDescription"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"prompt"},"value":{"kind":"Variable","name":{"kind":"Name","value":"prompt"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"isSuccessful"}},{"kind":"Field","name":{"kind":"Name","value":"response"}},{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}}]} as unknown as DocumentNode<AskChatGptQuery, AskChatGptQueryVariables>;
export const AddSelfDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"AddSelf"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"addSelfInput"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"AddSelfToEventInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"addSelfToEvent"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"addSelfInput"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"isSuccessful"}},{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}}]} as unknown as DocumentNode<AddSelfMutation, AddSelfMutationVariables>;
...
export const IsAdminOrUnionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"IsAdminOrUnion"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"isAdminOrUnion"}}]}}]} as unknown as DocumentNode<IsAdminOrUnionQuery, IsAdminOrUnionQueryVariables>;