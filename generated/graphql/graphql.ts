...
export type SendForgotPasswordVerificationEmailMutation = {
	__typename?: 'Mutation';
...
export type ResendForgotPasswordVerificationEmailMutation = {
	__typename?: 'Mutation';
...
export type BigEventsForHomeQuery = {
	__typename?: 'Query';
	events?: {
		__typename?: 'EventsCollectionSegment';
		totalCount: number;
		items?: Array<{ __typename?: 'EventDto'; id: string; title: string; description: string; image: string }> | null;
	} | null;
};
...
export type SliderEventsForHomeQuery = {
	__typename?: 'Query';
	events?: {
		__typename?: 'EventsCollectionSegment';
		items?: Array<{
...
export type CalendarEventsBigImageQuery = {
	__typename?: 'Query';
	events?: {
		__typename?: 'EventsCollectionSegment';
		items?: Array<{
...
export type AddSelfMutation = {
	__typename?: 'Mutation';
	addSelfToEvent: { __typename?: 'AddUserToEventPayload'; isSuccessful: boolean; message: string };
};
...
export type LoginMutation = {
	__typename?: 'Mutation';
	login: { __typename?: 'LoginPayload'; isSuccessful: boolean; message: string };
};
...
export type CreateUserMutation = {
	__typename?: 'Mutation';
	createUser: { __typename?: 'CreateUserPayload'; isSuccessful: boolean; message: string };
};
...
export type ChangePasswordMutation = {
	__typename?: 'Mutation';
	changePassword: { __typename?: 'ChangePasswordPayload'; isSuccessful: boolean; message: string };
};
...
export type VerifyUserMutation = {
	__typename?: 'Mutation';
	verifyUser: { __typename?: 'VerifyUserPayload'; isSuccessful: boolean; message: string };
};
...
export type UpdateUserMutation = {
	__typename?: 'Mutation';
	updateUser: { __typename?: 'UpdateUserPayload'; isSuccessful: boolean; message: string };
};
...
export type DeleteUserMutation = {
	__typename?: 'Mutation';
	deleteUser: { __typename?: 'DeleteUserPayload'; isSuccessful: boolean; message: string };
};
	...
	definitions: [
		{
			...
			operation: 'mutation',
			name: { kind: 'Name', value: 'SendForgotPasswordVerificationEmail' },
			variableDefinitions: [
				{
				...
				selections: [
					{
						...
						selectionSet: {
							kind: 'SelectionSet',
							selections: [
								{ kind: 'Field', name: { kind: 'Name', value: 'isSuccessful' } },
	...
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'mutation',
			name: { kind: 'Name', value: 'ResendForgotPasswordVerificationEmail' },
			selectionSet: {
				kind: 'SelectionSet',
				selections: [
					{
...
>;
export const BigEventsForHomeDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'BigEventsForHome' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
				...
				selections: [
					{
						...
						arguments: [
							...
							{ kind: 'Argument', name: { kind: 'Name', value: 'take' }, value: { kind: 'IntValue', value: '3' } },
						],
						selectionSet: {
							kind: 'SelectionSet',
							selections: [
...
} as unknown as DocumentNode<BigEventsForHomeQuery, BigEventsForHomeQueryVariables>;
export const SliderEventsForHomeDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'SliderEventsForHome' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'sorting' } },
							...
							selections: [
								{
									...
									selectionSet: {
										...
										selections: [
											...
											{ kind: 'Field', name: { kind: 'Name', value: 'title' } },
											{ kind: 'Field', name: { kind: 'Name', value: 'description' } },
											{ kind: 'Field', name: { kind: 'Name', value: 'mediumImage' } },
										],
									},
								},
							],
...
} as unknown as DocumentNode<SliderEventsForHomeQuery, SliderEventsForHomeQueryVariables>;
	...
	definitions: [
		{
			...
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'createEventInput' } },
						...
						arguments: [
							{
								kind: 'Argument',
								name: { kind: 'Name', value: 'input' },
								value: { kind: 'Variable', name: { kind: 'Name', value: 'createEventInput' } },
							},
						],
						selectionSet: {
							kind: 'SelectionSet',
...
export const GetBigEventImageDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
...
} as unknown as DocumentNode<GetBigEventImageQuery, GetBigEventImageQueryVariables>;
				...
				selections: [
					{
												...
												fields: [
													{
														...
														value: { kind: 'StringValue', value: '8200', block: false },
													},
												],
											},
										},
						...
						selectionSet: {
							...
							selections: [
								...
								{ kind: 'Field', alias: { kind: 'Name', value: 'image' }, name: { kind: 'Name', value: 'smallImage' } },
...
export const AddSelfDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'mutation',
			name: { kind: 'Name', value: 'AddSelf' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'addSelfInput' } },
					type: {
						kind: 'NonNullType',
						type: { kind: 'NamedType', name: { kind: 'Name', value: 'AddSelfToEventInput' } },
					},
				},
			],
			selectionSet: {
				...
				selections: [
					{
						kind: 'Field',
						name: { kind: 'Name', value: 'addSelfToEvent' },
						arguments: [
							{
								kind: 'Argument',
								name: { kind: 'Name', value: 'input' },
								value: { kind: 'Variable', name: { kind: 'Name', value: 'addSelfInput' } },
							},
						],
						selectionSet: {
							kind: 'SelectionSet',
...
} as unknown as DocumentNode<AddSelfMutation, AddSelfMutationVariables>;
	...
	definitions: [
		{
			...
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'changePassword' } },
					type: {
						kind: 'NonNullType',
						...
						arguments: [
							{
								kind: 'Argument',
								name: { kind: 'Name', value: 'input' },
								value: { kind: 'Variable', name: { kind: 'Name', value: 'changePassword' } },
							},
						],
						selectionSet: {
							kind: 'SelectionSet',
	...
	definitions: [
		{
			...
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'verifyUserInput' } },
						...
						arguments: [
							{
								kind: 'Argument',
								name: { kind: 'Name', value: 'input' },
								value: { kind: 'Variable', name: { kind: 'Name', value: 'verifyUserInput' } },
							},
						],
						selectionSet: {
							kind: 'SelectionSet',
	...
	definitions: [
		{
			...
			selectionSet: {
				kind: 'SelectionSet',
				selections: [{ kind: 'Field', name: { kind: 'Name', value: 'validateSession' } }],
			},
		},
	],
} as unknown as DocumentNode<ValidateSessionQuery, ValidateSessionQueryVariables>;
